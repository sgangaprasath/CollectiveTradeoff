...
\subsection*{Trail following behavior}
Social insects such as ants communicate through pheromone or by antennation. As stigmergy is one of the fundamental
mechanisms by which the collective coordinates and recruits new workers.
it can make measurements about how far from the
