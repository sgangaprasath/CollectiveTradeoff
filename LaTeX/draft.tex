...
evolution of the variance of agent's position $\r(s)$ as it marches close to the target.

Assuming that the agent reaching a distance $\sigma$ from the end-point A can reach the
...
\onecolumngrid
\begin{center}
\textbf{\large Supplemental Information for ``Branching in soft gels''}\\[.2cm]
S  Ganga  Prasath$^{1, *}$, Aditi Chakrabarti$^{1, *}$,  and  L  Mahadevan$^{1, 2, 3, 4}$\\[.1cm]
{\small \itshape ${}^1$School of Engineering and Applied Sciences, Harvard University, Cambridge MA 02138.\\
...
${}^4$Department of Organismic and Evolutionary Biology, Harvard University, Cambridge 02138
}
\end{center}
